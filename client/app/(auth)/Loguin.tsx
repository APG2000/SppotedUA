    ...
    >
      ...
      <View className="  h-[65%] w-[95%] rounded-xl pl-2 pr-2 pt-2 pb-2  justify-center">
        ...
        <View className="flex items-center mt-10 gap-4">
          ...
          <Text className="text-white mt-5 font-light">
            🔒 Suas interações são 100% anônimas
          </Text>
        ...
        <View className="flex flex-row items-center  mt-2 justify-center gap-2">
            ...
            <Link
              href={"/(auth)/Register"}
              className="text-white font-extrabold text-2xl border-b-2 border-b-[#FE8C00]"
            >
              Crie aqui
            </Link>
